...
window.addEventListener('load', function () {
    ...
    var initButtonsHandlers = function initButtonsHandlers() {
        var handlersWrap = document.querySelector('.handlers');
        handlersWrap.innerHTML = '<button class="js-todo-add-handlers">Add Events</button>' + '<button class="js-todo-remove-handlers">Remove Events</button>';
    };
    ...
    function createElement() {
        ...
        var liStructure = '<span class="todo__item-text" contenteditable="false"></span>' + '<div class="todo__item-buttons">' + '<button class="todo__item-button js-todo-edit">Edit</button>' + '<button class="todo__item-button js-todo-remove">Remove</button>' + '<button class="todo__item-button js-todo-done">Done</button>' + '</div>';
    ...
    function editElement() {
        var elemParent = this.parentNode.parentNode;
    ...
    var addHandlers = function addHandlers() {
        document.querySelectorAll('.js-todo-edit').forEach(function (btn) {
            btn.addEventListener('click', editElement);
        });

        document.querySelectorAll('.js-todo-done').forEach(function (btn) {
            btn.addEventListener('click', completeElement);
        });

        document.querySelectorAll('.js-todo-remove').forEach(function (btn) {
