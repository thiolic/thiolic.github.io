...
window.addEventListener('load', function () {
    var sum = function sum(array) {
        var sumOfElements = array.reduce(function (sum, elem) {
            return sum + elem;
        }, 0);
    ...
    var range = function range(startValue, endValue, step) {
        step = step || 1;
        var array = [];

        if (startValue < endValue) {
            for (var i = startValue; i <= endValue; i = i + step) {
                array.push(i);
            }
        } else {
            for (var _i = startValue; _i >= endValue; _i = _i + step) {
                array.push(_i);
            }
        }
