...
window.addEventListener('load', function () {
    ...
    var arrayToListReduce = function arrayToListReduce(arr) {
        var list = {};

        arr.reduceRight(function (current, elem) {
    ...
    var prepend = function prepend(elem, list) {
        return list = { value: elem, rest: list };
    };

    var nth = function nth(list, num) {
        var counter = 0;
        var element = void 0;
