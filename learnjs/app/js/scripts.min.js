...
window.addEventListener('load', function () {
    ...
    var createElement = function createElement() {
        ...
        var liStructure = '<div><label for="checkbox-' + counter + '" class="todo__item-text" contenteditable="false"></label>' + '<input type="checkbox" class="todo__checkbox" id="checkbox-' + counter + '" name="checkbox-' + counter + '"></div>' + '<div class="todo__item-buttons">' + '<button class="todo__item-button -edit">Edit</button>' + '<button class="todo__item-button -remove">Remove</button>' + '</div>';
