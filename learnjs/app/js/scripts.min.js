...
window.addEventListener('load', function () {
    ...
    var createElement = function createElement() {
        ...
        var liStructure = '<span class="todo__item-text" contenteditable="false"></span>' + '<div class="todo__item-buttons">' + '<button class="todo__item-button -edit">Edit</button>' + '<button class="todo__item-button -remove">Remove</button>' + '</div>';
